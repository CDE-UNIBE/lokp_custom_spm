...
INSERT INTO data.sh_keys (id, fk_sh_key, fk_language, key, type, helptext, description, validator) VALUES
  ...
  (7, NULL, NULL, 'Year since involvement in Madagascar', 'Integer', NULL, NULL, NULL),
  (8, NULL, NULL, 'Number of local staff employed', 'Integer', NULL, NULL, NULL),
  (9, NULL, NULL, 'Number of expatriate staff employed', 'Integer', NULL, NULL, NULL),
  (10, NULL, NULL, 'Approximate annual turnover', 'Dropdown', NULL, NULL, NULL),
  ...
  (16, NULL, NULL, 'Ranking', 'Integer', NULL, NULL, NULL),
