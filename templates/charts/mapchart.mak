...
<%def name="title()">${_("Stakeholder Map")}</%def>
    ...
    <div class="row-fluid">
      <div class="span6 hidden-phone">
        ...
        <div id="helptext" class="hide">
          ...
          <p>${_('The map shows the country of origin of Stakeholders involved in Activities.')}</p>
          <p>${_('The colors represent the number of Stakeholders from a certain country. The darker the color, the more Stakeholders.')}</p>
