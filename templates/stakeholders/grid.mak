    ...
    <div class="content">
        ...
        <ul class="nav nav-tabs table_tabs">
            ...
            <li class="grid-tab-right">
                <a href="${request.route_url('stakeholders_read_many', output='download')}${handle_query_string(request.url, return_value='query_string', remove=['order_by', 'dir', 'status'])}" data-toggle="tooltip" title="${_('Download Stakeholders')}">
...
<%def name="bottom_tags()">
    ...
    <script type="text/javascript">
        ...
        var link_involvement_text = '${_("Show activities of this stakeholder")}';
    </script>
