...
<rss version="2.0">
    <channel>
        <title>${_('Version history of stakeholder #%s' % versions[0]['identifier'].split('-')[0])}</title>
        <link></link>
        ...
        <item>
            ...
            <description>
                ...
                % if v['statusId'] != 2:
                <span>
                    <a href="${request.route_url('stakeholders_read_one', output='compare', uid=v['identifier'], _query=(('ref', v['version']),('new', activeVersion)))}">
