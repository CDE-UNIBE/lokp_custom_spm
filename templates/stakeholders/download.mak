    ...
    <div class="content no-border">
        ...
        <div class="row-fluid">
            ...
            <div class="alert alert-info">
                ${_('Only Stakeholders which have been approved by a moderator will appear in the downloads.')}
            </div>
            <p>
                ${_('Please note that the Stakeholders are filtered spatially. Only Stakeholders involved in Activities which are visible on the map will be downloaded. Also filters based on the attributes of Activities or Stakeholders will be applied.')}
            </p>
        </div>
        <form method="POST">
            <div class="row-fluid">
